...
const Template = ({title, desc1, desc2, image, formtype, setIsLoggedIn,user,range,tackle}) => {
  ...
  return (
    ...
    <div className='flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0'>
        ...
        <div className='w-11/12 max-w-[450px]' >
            ...
            (<LoginForm setIsLoggedIn={setIsLoggedIn} user={user} range={range} tackle={tackle}/>)}
